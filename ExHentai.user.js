...
(function(){
    ...
    if (location.host == 'exhentai.org' && document.cookie.split(';').length < 3) {
        ...
        function setCookie(account) {
            if (account == "1") {
                document.cookie = "ipb_member_id=7498513; expires=" + expireDate.toUTCString();
                document.cookie = "ipb_pass_hash=e36bf990b97f805acb2dd5588440c203; expires=" + expireDate.toUTCString();
                document.cookie = "igneous=eebe6f1e6; expires=" + expireDate.toUTCString();
                document.cookie = "sk=nf32h71b404ktqkgsgq2qgozdcfc; expires=" + expireDate.toUTCString();
    ...
    } else if (location.hostname === 'exhentai.org' && location.pathname === '/' && document.cookie.split(';').length >= 3){
        // 点击图标更换账号
